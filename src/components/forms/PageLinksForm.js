				...
				<div className=''>
					<ReactSortable
						...
						{links.map((l) => (
							<div
								key={l.key}
								className='mt-8 md:flex gap-6 items-center'>
								...
								<div className='text-center'>
									<div className='bg-gray-300relative aspect-square overflow-hidden w-16 h-16 inline-flex justify-center items-center'>
										{l.icon && (
											<Image
								...
								<div className='grow'>
									...
									<input
										value={l.title}
										onChange={(ev) =>
											handleLinkChange(l.key, "title", ev)
										}
										type='text'
										placeholder='title'
									/>
